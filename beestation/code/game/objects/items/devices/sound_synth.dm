...
/obj/item/soundsynth
	...
	var/static/list/sound_list = list(
		...
		"Applause" = "selected_sound=beestation/sound/effects/applause.ogg&shiftpitch=1&volume=65",
		"Laughter" = "selected_sound=beestation/sound/effects/laughtrack.ogg&shiftpitch=1&volume=65",
		"Rimshot" = "selected_sound=beestation/sound/effects/rimshot.ogg&shiftpitch=1&volume=65",
		...
		"Short Slide Whistle" = "beestation/selected_sound=sound/effects/slide_whistle_short.ogg&shiftpitch=1&volume=50",
		"Long Slide Whistle" = "beestation/selected_sound=sound/effects/slide_whistle_long.ogg&shiftpitch=1&volume=50",
		"YEET" = "selected_sound=beestation/sound/effects/yeet.ogg&shiftpitch=1&volume=50",
